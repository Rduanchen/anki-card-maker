...
## APP 頁面
<img width="1917" height="991" alt="image" src="https://github.com/user-attachments/assets/7b08e76d-64bc-4ed2-a0eb-8d6e72a24757" />
<img width="1919" height="989" alt="image" src="https://github.com/user-attachments/assets/f38a3815-c55b-420b-9210-d3c7cfe0140f" />
## ANKI 卡片
<img width="1861" height="833" alt="image" src="https://github.com/user-attachments/assets/9e29643e-6d42-46eb-b16b-d2d572e93f98" />
...
* **智慧補全**：整合 Auto-complete 自動下拉選單，以協助查詢
* **錯誤標示**：輸入無效或不存在的單字時，會標出錯誤的單字並且阻止送出

### 2. Cambridge 字典 (Cambridge Dictionary Scraper)
...
### 4. 歷史紀錄與管理 (History Tracking)
* 自動儲存查詢歷史，方便隨時複習與重新匯出，避免重複查詢。

### 5. 級視覺設計與使用者體驗 (Premium UI/UX)
